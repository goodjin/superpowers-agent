...
- `sidebar_content`：右侧栏主体，是 workflow 会话运行信息的主展示区域。展示 workflow 总览、运行中 child session 列表；当 OpenCode pending question API 返回 child session question 时，优先展示问题正文和选项摘要。
